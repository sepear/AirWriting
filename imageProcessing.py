#Aquí tenemos algunos métodos para el procesado
...
FMSize = (3, 3)  # tupla de dos nï¿½meros iguales
EKSize = (3, 3)  # idem
EIteraciones = 1  # iter
DKSize = (3, 3)  # tupla
DIteraciones = 1  # iter
...
UMBRAL_UNIFICACION = 8  # SI DOS PUNTOS ESTÃN A MENOS DE 8 PIXELES DE DISTANCIA, SE UNIFICAN
